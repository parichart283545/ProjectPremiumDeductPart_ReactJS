...
import deductFirstPeriod from "../modules/DeductBankAccount/pages/DeductFirstPeriodPage";
import deductContinuePeriod from "../modules/DeductBankAccount/pages/DeductContinuePeriodPage";
import manageDeductPremiumPage from "../modules/ManageDeductBankAccount/pages/ManageDeductPremiumPage";
import TestPage from "../modules/ManageDeductBankAccount/pages/TestPage";
import DetailFileDeductPage from "../modules/ManageDeductBankAccount/pages/DetailFileDeductPage";
import UploadResultPage from "../modules/ManageDeductBankAccount/pages/UploadResultPage";
import ManageDeductBankAccountPage from "../modules/ManageDeductBankAccount/pages/ManageDeductBankAccountPage";
  ...
  return (
    <React.Fragment>
      <Switch>
        ...
        <ContentRoute
          exact
          title="ยืนยันตั้งหนี้หักบัญชีธนาคาร(หักงวดแรก)"
          path="/deductBankAccount/deductFirstPeriodPage"
          component={deductFirstPeriod}
        />
        <ContentRoute
          exact
          title="ยืนยันตั้งหนี้หักบัญชีธนาคาร(งวดต่ออายุรายเดือน)"
          path="/deductBankAccount/deductContinuePeriodPage"
          component={deductContinuePeriod}
        />
        <ContentRoute
          exact
          title="จัดการรายการส่งหักเบี้ย"
          path="/manageDeductBankAccount/manageDeductPremiumPage"
          component={manageDeductPremiumPage}
        />
        <ContentRoute
          exact
          title="รายละเอียดไฟล์ส่งหักธนาคาร"
          path="/manageDeductBankAccount/detailFileDeductPage"
          component={DetailFileDeductPage}
        />
        <ContentRoute
          exact
          title="อัพโหลดไฟล์ผลหักบัญชี"
          path="/manageDeductBankAccount/uploadResultPage"
          component={UploadResultPage}
        />
        <ContentRoute
          exact
          title="จัดการรายการส่งหักบัญชีธนาคาร"
          path="/manageDeductBankAccount/manageDeductBankAccountPage"
          component={ManageDeductBankAccountPage}
        />
        <ContentRoute
          exact
          title="ทดสอบ"
