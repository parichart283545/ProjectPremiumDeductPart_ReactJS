...
import * as deductLayoutRedux from '../_redux/deductLayoutRedux.js';
...
function ContinuePeriodSearchBox(props) {
            ...
            >
                <Grid item xs={12} lg={2}>
                    <Button
                        ...
                        startIcon={<Add />}
                        onClick={() => {
                            dispatch(deductLayoutRedux.actions.openCont())
                        }}
                    >
                        ยืนยันส่ง
                    </Button>
...
export default ContinuePeriodSearchBox
