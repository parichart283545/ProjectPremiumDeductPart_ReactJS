...
import FirstPeriodSearchBox from '../components/FirstPeriodSearchBox';
...
function FirstPeriodGroupTable() {
    ...
    const columns = [
        ...
        {
            name: "NoticeBillingDateRange",
            label: "ช่วงเวลาวันที่แจ้งชำระ"
        },
        {
            name: "CreatedDate",
                ...
                >
                    <Grid item xs={12} lg={12}>
                        <Paper elevation={3} style={{ padding: 20, marginBottom: 0, marginTop: 8 }}>
                            <FirstPeriodSearchBox updateSearch={handleUpdateSearch.bind(this)}></FirstPeriodSearchBox>
                        </Paper>
                    </Grid>
                    <Grid container style={{ marginTop: -10 }}>
                        <Grid item xs={12} lg={12}>
                            <StandardDataTable
                                ...
                                title=""
                                columns={columns}
                                data={deductionReducer.firstPeriodGroup}
                                paginated={paginated}
...
export default FirstPeriodGroupTable
