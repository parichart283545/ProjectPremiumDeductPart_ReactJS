...
function DialogFirstPeriod() {
    ...
    const resetLayoutPromise = () =>
        new Promise((resolve) => {
            dispatch(deductLayoutRedux.actions.closeFirst());
            resolve();
        });
    //#endregion promise
    ...
    const formik = useFormik({
        ...
        initialValues: {
            selectedData: deductBankAccountReducer.firstPeriodItem
        },
        onSubmit: (values) => {
            //submit .... 
            //TODO: Save 
    ...
    return (
        <Dialog
            open={deductLayoutReducer.dialogFirst.open}
            onClose={handleClose}
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={12}>
                            ...
                            >
                                <StandardDataTable
                                    ...
                                    title=""
                                    columns={columns}
                                    data={deductBankAccountReducer.firstPeriodItem}
                                    paginated={paginated}
...
export default DialogFirstPeriod
