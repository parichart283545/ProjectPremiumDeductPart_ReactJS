...
import ManageDeductPremuimAdvSearch from './ManageDeductPremuimAdvSearch';

function ManageDeductPremuimAdvTable() {
...
export default ManageDeductPremuimAdvTable
